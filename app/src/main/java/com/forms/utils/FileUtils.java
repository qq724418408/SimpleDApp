...
public class FileUtils {
    ...
    public static boolean deleteFile(String fileName) {
        ...
        if (file.isFile() && file.exists()) {
            file.delete();
            LogUtil.d("删除单个文件" + fileName + "成功！");
            return true;
        } else {
            LogUtil.d("删除单个文件" + fileName + "失败！");
            return false;
        }
    }
    ...
    public static boolean deleteDirectory(String dir) {
        ...
        // 删除当前目录
        if (dirFile.delete()) {
            LogUtil.d("删除目录" + dir + "成功！");
            return true;
        } else {
            LogUtil.d("删除目录" + dir + "失败！");
            return false;
        }
    }
    ...
    public static File getStorageFile(String derectoryPath, String fileName) {
        ...
        if (derectory != null) {
            ...
            LogUtil.d("targetFile=" + targetFilePath);
